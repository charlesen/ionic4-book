...
Le paramètre **_"-g"_** permet une installation globale de ces outils. De cette manière, vous n'aurez pas besoin d'être dans un répertoire particulier pour utiliser les commandes **ionic** ou **cordova**, sauf pour des actions comme la compilation qui requiert d'être à l'intérieur d'un projet.
